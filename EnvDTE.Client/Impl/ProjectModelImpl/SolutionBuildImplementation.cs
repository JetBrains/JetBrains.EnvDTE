    ...
    : SolutionBuild2
{
    ...
    public SolutionConfiguration ActiveConfiguration => throw new NotImplementedException();
    ...
    public SolutionConfigurations SolutionConfigurations => throw new NotImplementedException();
